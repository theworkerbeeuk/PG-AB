...
(function() {
  ...
  this.BrowserDetection = {
    ...
    name: function() {
      ...
      if (this.getAgent().match(/Firefox\/\d*\.*\d*/)) {
        return "Firefox";
      }
      if (this.getAgent().match(/Version\/\d*\.*\d*\.*\d* Safari/)) {
        return "Safari";
      }
      if (this.getAgent().match(/Windows Phone\d*\.*\d*/)) {
        return "WP";
      }
      if (this.getAgent().match(/MSIE \d*\.*\d*/)) {
        return "Internet Explorer";
      }
      if (this.getAgent().match(/^Opera/)) {
        return "Opera";
      }
      if (this.getAgent().match(/Android/)) {
        return "android";
      }
      if (this.getAgent().match(/iPhone/)) {
        return "iOS";
      }
      if (this.getAgent().match(/iPad/)) {
        return "iOS";
      }
      return "UKNOWN";
    },
